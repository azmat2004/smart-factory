...
function ensureDatabase() {
  ...
  db.exec(`
    CREATE TABLE IF NOT EXISTS t_factory (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, bak TEXT, factory_name TEXT, factory_img_url TEXT,
      factory_addr TEXT, factory_url TEXT, factory_worker INTEGER, factory_status INTEGER DEFAULT 0
    );
    CREATE TABLE IF NOT EXISTS t_user_role (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, role_desc TEXT, role_name TEXT, role_status INTEGER DEFAULT 0, factory_id INTEGER
    );
    CREATE TABLE IF NOT EXISTS t_user (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, user_status INTEGER DEFAULT 0, user_name TEXT NOT NULL,
      user_real_name TEXT, user_passwd TEXT NOT NULL, user_job_num TEXT, user_phone_num TEXT,
      user_email TEXT, role_id INTEGER, factory_id INTEGER NOT NULL
    );
    CREATE TABLE IF NOT EXISTS t_product (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, product_num TEXT NOT NULL, product_name TEXT NOT NULL,
      product_img_url TEXT, factory_id INTEGER NOT NULL
    );
    CREATE INDEX IF NOT EXISTS idx_pn ON t_product(product_num);
    CREATE TABLE IF NOT EXISTS t_equipment (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, equipment_seq TEXT NOT NULL, equipment_name TEXT,
      equipment_img_url TEXT, equipment_status INTEGER DEFAULT 10, factory_id INTEGER NOT NULL
    );
    CREATE TABLE IF NOT EXISTS t_equipment_product (
      id INTEGER PRIMARY KEY AUTOINCREMENT, equipment_id INTEGER NOT NULL, product_id INTEGER NOT NULL,
      yield INTEGER, unit INTEGER, factory_id INTEGER NOT NULL
    );
    CREATE TABLE IF NOT EXISTS t_product_order (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, order_seq TEXT NOT NULL, order_source INTEGER DEFAULT 1,
      product_id INTEGER, product_count INTEGER NOT NULL, end_date TEXT NOT NULL, order_status INTEGER DEFAULT 10,
      factory_id INTEGER NOT NULL, factory_yield INTEGER
    );
    CREATE INDEX IF NOT EXISTS idx_os ON t_product_order(order_seq);
    CREATE TABLE IF NOT EXISTS t_product_plan (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, plan_seq TEXT, order_id INTEGER NOT NULL,
      product_id INTEGER NOT NULL, plan_count INTEGER, delivery_date TEXT, plan_start_date TEXT,
      plan_end_date TEXT, plan_status INTEGER DEFAULT 10, factory_id INTEGER NOT NULL
    );
    CREATE INDEX IF NOT EXISTS idx_ps ON t_product_plan(plan_seq);
    CREATE TABLE IF NOT EXISTS t_product_schedule (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, schedule_seq TEXT, schedule_count INTEGER,
      schedule_status INTEGER DEFAULT 10, plan_id INTEGER NOT NULL, product_id INTEGER NOT NULL,
      equipment_id INTEGER, start_date TEXT, end_date TEXT, factory_id INTEGER NOT NULL
    );
    CREATE TABLE IF NOT EXISTS t_order_track (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, schedule_id INTEGER, plan_id INTEGER,
      product_id INTEGER, working_count INTEGER DEFAULT 0, qualified_count INTEGER DEFAULT 0, factory_id INTEGER NOT NULL
    );
    CREATE INDEX IF NOT EXISTS idx_ot ON t_order_track(schedule_id);
    CREATE TABLE IF NOT EXISTS t_daily_work (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, schedule_id INTEGER NOT NULL, equipment_id INTEGER,
      equipment_seq TEXT, start_time TEXT, end_time TEXT, working_count INTEGER,
      qualified_count INTEGER, unqualified_cout INTEGER, complete_flag INTEGER DEFAULT 1,
      factory_id INTEGER NOT NULL, bak TEXT
    );
    CREATE TABLE IF NOT EXISTS t_permit (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, status INTEGER DEFAULT 0,
      parent_id INTEGER, permit_name TEXT, permit_desc TEXT, permit_path TEXT
    );
    CREATE TABLE IF NOT EXISTS t_role_permit (
      id INTEGER PRIMARY KEY AUTOINCREMENT, flag INTEGER DEFAULT 0, create_time TEXT, create_userid INTEGER,
      update_time TEXT, update_userid INTEGER, factory_id INTEGER, role_id INTEGER, permit_id INTEGER
    );
  `);
  ...
  db.exec(`
    ...
    (2,0,'${now}',1,NULL,NULL,'订单管理员','订单管理员',0,1),
    (3,0,'${now}',1,NULL,NULL,'计划管理员','计划管理员',0,1),
    (4,0,'${now}',1,NULL,NULL,'调度管理员','调度管理员',0,1),
    (5,0,'${now}',1,NULL,NULL,'生产员工','生产员工',0,1);
  ...
  `);
  console.log('数据库初始化完成！默认账户: admin / 123456');
}
